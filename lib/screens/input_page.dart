...
import 'package:bmi/components/weigt_age_card.dart';
          ...
          BottomButton(
              ...
              onTap: () {
                ...
                Navigator.push(context,
                    new MaterialPageRoute(builder: (context) => Result(bmiResult: cal.calculatebmi(),resultText: cal.getResult(),interpretation: cal.getInterpretation(),)));
              }),
        ],
      ),
    );
